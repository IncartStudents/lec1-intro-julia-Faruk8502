...
s3*s4
myphonebook = Dict("Jenny" => "867-5309", "Ghostbusters" => "555-23")
myphonebook["Kramer"] = "555-FILK"
pop!(myphonebook, "Kramer")
myfavoriteanimals = ["dogs", "cats"]
...
push!(fibonacci, 21)
pop!(fibonacci)
favorite = [["koobideh", "chocolate", "eggs"], ["penguons", "cats", "sugargliders"]]
